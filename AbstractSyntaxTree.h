...
public:
	...
	virtual void PrintJSON(std::ofstream& out, std::string& parentID, std::vector<std::string>& config) = 0;
};
...
public:
	...
	virtual void PrintJSON(std::ofstream& out, std::string& parentID, std::vector<std::string>& config) override
	{
		std::string myID = GenerateJSON(out, this, "UNARY", parentID, { (char)GetTokenValue(op) }, config);
		expr->PrintJSON(out, myID, config);
	}
};
...
public:
	...
	virtual void PrintJSON(std::ofstream& out, std::string& parentID, std::vector<std::string>& config) override
	{
		GenerateJSON(out, this, "INT", parentID, std::to_string(value), config);
	}
};
...
public:
	...
	virtual void PrintJSON(std::ofstream& out, std::string& parentID, std::vector<std::string>& config) override
	{
		GenerateJSON(out, this, "ID", parentID, value, config);
	}
};
...
public:
	...
	virtual void PrintJSON(std::ofstream& out, std::string& parentID, std::vector<std::string>& config) override
	{
		std::string myID = GenerateJSON(out, this, "BINOP", parentID, { (char)GetTokenValue(op) }, config);
		left->PrintJSON(out, myID, config);
		right->PrintJSON(out, myID, config);
	}
};
...
public:
	...
	virtual void PrintJSON(std::ofstream& out, std::string& parentID, std::vector<std::string>& config) override
	{
		std::string myID = GenerateJSON(out, this, "COND", parentID, { (char)GetTokenValue(op) }, config);
		left->PrintJSON(out, myID, config);
		right->PrintJSON(out, myID, config);
	}
};
...
public:
	...
	virtual void PrintJSON(std::ofstream& out, std::string& parentID, std::vector<std::string>& config) override
	{
		std::string myID = GenerateJSON(out, this, "IF", parentID, "IF", config);
		condition->PrintJSON(out, myID, config);
		if (body) body->PrintJSON(out, myID, config);
	}
};
...
public:
	...
	virtual void PrintJSON(std::ofstream& out, std::string& parentID, std::vector<std::string>& config) override
	{
		std::string myID = GenerateJSON(out, this, "WHILE", parentID, "WHILE", config);
		condition->PrintJSON(out, myID, config);
		if (body) body->PrintJSON(out, myID, config);
	}
};
...
public:
	...
	virtual void PrintJSON(std::ofstream& out, std::string& parentID, std::vector<std::string>& config) override
	{
		for (const auto& statement : statements) statement->PrintJSON(out, parentID, config);
	}
};
...
public:
	...
	virtual void PrintJSON(std::ofstream& out, std::string& parentID, std::vector<std::string>& config) override
	{
		std::string myID = GenerateJSON(out, this, "ASSIGN", parentID, { (char)GetTokenValue(op) }, config);
		left->PrintJSON(out, myID, config);
		right->PrintJSON(out, myID, config);
	}
};
